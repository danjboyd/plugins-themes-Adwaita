...
GnomeThemePopulateDarkPalette(NSColorList *colors)
{
  ...
  [colors setColor: GnomeThemeColorFromHex (@"#2e2e2e") forKey: @"controlBackgroundColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#383838") forKey: @"controlColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#78aeed") forKey: @"controlHighlightColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#9bc8ff") forKey: @"controlLightHighlightColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#1a1a1a") forKey: @"controlShadowColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#0f0f0f") forKey: @"controlDarkShadowColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#f4f4f4") forKey: @"controlTextColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#9c9c9c") forKey: @"disabledControlTextColor"];
  ...
  [colors setColor: GnomeThemeColorFromHex (@"#3b3f45") forKey: @"selectedInactiveColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#1e1e1e") forKey: @"textBackgroundColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#f4f4f4") forKey: @"textColor"];
  ...
  [colors setColor: GnomeThemeColorFromHex (@"#4a4d50") forKey: @"menuSeparatorColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#242424") forKey: @"menuBarBackgroundColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#3f4246") forKey: @"menuBarBorderColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#3f4246") forKey: @"menuBorderColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#5a5a5a") forKey: @"scrollBarColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#303235") forKey: @"headerColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#f5f5f5") forKey: @"headerTextColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#3f4246") forKey: @"gridColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#31577f") forKey: @"highlightedTableRowBackgroundColor"];
  ...
  [colors setColor: GnomeThemeColorFromHex (@"#2a2a2a") forKey: @"alternateRowBackgroundColor"];
  ...
  [colors setColor: GnomeThemeColorFromHex (@"#ffffff") forKey: @"windowFrameTextColor"];
  [colors setColor: GnomeThemeColorFromHex (@"#151515") forKey: @"windowFrameColor"];
